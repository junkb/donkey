...
/// placeholder shell for the contact list window. tier 3 replaces the content
/// view with an nsoutlineview-backed contact list imported from adium.
final class MainWindowController: NSWindowController {
    ...
    convenience init() {
        ...
        // remembers position and size across launches, keyed by this name in
    ...
    override func windowDidLoad() {
        ...
        let label = NSTextField(labelWithString: "nothing here yet")
